...
use crate::models::{self, common::PaginationParams, equipmentset::{NewEquipmentSet, EquipmentSet, EquipmentSetChangeset}, tournament::Tournament};
...
async fn read(
    ...
    match models::equipmentset::read(&mut conn, item_id.into_inner()) {
        Ok(equipmentset) => HttpResponse::Ok().json(equipmentset),
...
//     match models::game::read_all_games_of_equipmentset(&mut conn, tour_id.into_inner(), &params) {
