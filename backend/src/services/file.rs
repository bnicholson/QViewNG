...
// // For uploading files: Use actix_multipart::Multipart streams (often with 
// //     futures_util::StreamExt for processing chunks).
// // For downloading files as attachments: Build an HttpResponse with headers 
// //     like Content-Disposition: attachment; filename="example.pdf".
