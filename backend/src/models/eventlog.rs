use diesel::{AsChangeset,Insertable,Identifiable,Queryable,RunQueryDsl,insert_into};
use crate::database;
...
use crate::schema::eventlogs::dsl::{
    clientkey,organization,bldgroom,tournament,division,room,round,question,eventnum,
    name,team,quizzer,event,parm1,parm2,ts,clientip,md5digest,nonce,s1s
};
