...
//     let new_room = new_room_one(tid, "Test Div 3276");
...
//     div_3_name: &str,
// ) -> Vec<Room> {
//     let new_room_1 = new_room_one(tid, div_1_name);
//     let new_room_2 = new_room_two(tid, div_2_name);
//     let new_room_3 = new_room_three(tid, div_3_name);
