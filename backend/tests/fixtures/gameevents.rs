...
//         .build_and_insert(db)
//         .unwrap();
//     let gameevent_1 = GameEventBuilder::new_default(equipment_set.id)
//         .set_brand(Some("Brand A".to_string()))
//         .set_operating_system(Some("OS A".to_string()))
//         .set_misc_note(Some("First test gameevent.".to_string()))
//         .build_and_insert(db)
//         .unwrap();
//     let gameevent_2 = GameEventBuilder::new_default(equipment_set.id)
//         .set_brand(Some("Brand B".to_string()))
//         .set_operating_system(Some("OS B".to_string()))
//         .set_misc_note(Some("Second test gameevent.".to_string()))
//         .build_and_insert(db)
//         .unwrap();
