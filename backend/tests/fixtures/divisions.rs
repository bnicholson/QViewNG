...
pub fn seed_get_rounds_by_division(conn: &mut PgConnection) -> Division {
    ...
    let div_1_rounds = seed_rounds_with_sched_start_times(conn, div_1.did, start_time_1, start_time_2, start_time_3);
    ...
    let div_2_rounds = seed_rounds_with_sched_start_times(conn, div_2.did, start_time_4, start_time_5, start_time_6);
    ...
    let div_3_rounds = seed_rounds_with_sched_start_times(conn, div_3.did, start_time_7, start_time_8, start_time_9);

    let mut return_vec = div_1_rounds;
    return_vec.extend(div_2_rounds);
    return_vec.extend(div_3_rounds);
