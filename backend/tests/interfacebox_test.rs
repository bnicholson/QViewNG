...
async fn create_works() {
    ...
    let req = test::TestRequest::post()
        .uri("/api/equipment/interfaceboxes")
        .set_json(&payload)
        .to_request();
...
//     let uri = format!("/api/equipment/interfaceboxes/{}", &interfacebox.equipmentid);
...
//     assert_eq!(resp_interfacebox.color, interfacebox.color);
// }
...
//     assert_eq!(new_interfacebox.interfaceboxid, original_interfacebox.interfaceboxid);
//     assert_eq!(new_interfacebox.color, new_color);
