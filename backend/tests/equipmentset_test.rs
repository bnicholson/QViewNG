...
async fn get_by_id_works() {
    ...
    let equipmentset = 
        fixtures::equipmentsets::arrange_get_equipmentset_by_id_works_integration_test(&mut conn);
    ...
    let uri = format!("/api/equipmentsets/{}", &equipmentset.id);
...
async fn update_works() {
    ...
    let put_uri = format!("/api/equipmentsets/{}", original_equipmentset.id);
...
async fn delete_works() {
    ...
    let delete_uri = format!("/api/equipmentsets/{}", equipmentset.id);
    ...
    let get_by_id_uri = format!("/api/equipmentsets/{}", equipmentset.id);
