...
CREATE TABLE tournamentgroups (
    tgid UUID PRIMARY KEY DEFAULT gen_random_uuid(),  -- a unique id for the tournamentgroup; just an identifiable grouping
...
CREATE TABLE tournamentgroups_tournaments (
    ...
    tournamentgroupid UUID NOT NULL REFERENCES tournamentgroups(tgid) ON DELETE CASCADE,
    created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
