...
# This was initially added for optimizing speed of integration tests by making DB in-memory
...
cargo test --test tournament_test -- --test-threads=1  # for single integration test file; uses a single test DB synchronously (for now)