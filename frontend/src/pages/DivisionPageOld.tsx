...
// This page is what the Tournaments results used to navigate to when you clicked on a specific Tournament.
// It has been replaced by the TournamentProfile page. This might not be needed at all in the future but keeping
...
Description: {short info} {full description}
`

export const Divisions = () => {
  const [valuemd, setValuemd] = React.useState(defaultMarkdown)
