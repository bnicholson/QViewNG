...
function createData(
  ...
  return { key: create_data_key_num, tournament, division, room, round, question, done, dataok, information };
}
...
const rows = Array.from({ length: 270 }, () => BASE_ROWS).flat();
